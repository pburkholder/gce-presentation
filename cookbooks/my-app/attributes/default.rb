...
default['my-app']['webserver']['apache_port'] = '8080'
default['my-app']['webserver']['server_name'] = 'www.mysite.com'
default['my-app']['webserver']['server_aliases'] = Array[]

# Load balancer configuration
default['my-app']['balancer']['webservers'] = Array[]
default['my-app']['balancer']['server_name'] = 'www.mysite.com'
default['my-app']['balancer']['port'] = '80'
default['my-app']['balancer']['server_aliases'] = Array[]
